...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, feat, num_stages, scale_factor):
        ...
        #Reconstruction
        self.output_conv = ConvBlock(num_stages*base_filter, num_channels, 3, 1, 1, activation='prelu', norm=None)
        self.final_conv = ConvBlock(num_channels, 1, 3, 1, 1, activation=None, norm=None)
